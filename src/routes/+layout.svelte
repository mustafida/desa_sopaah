				...
				<div class="flex justify-between items-center h-20">
					...
					<a href="/" class="flex items-center gap-3 group">
						...
						<div class="flex flex-col">
							...
							<span
								class="text-xs font-semibold text-green-100 uppercase tracking-wider leading-tight"
							>
								Kabupaten Pamekasan
							</span>
						</div>
					...
					<!-- Desktop Menu -->
					<div
						class="hidden md:flex space-x-6 lg:space-x-8 items-center font-bold text-sm lg:text-base"
					>
						<a
							href="/"
						...
						<a
							href="/profil"
							class="transition-colors {$page.url.pathname === '/profil'
								? 'text-white underline underline-offset-4 decoration-2'
								: 'text-green-100 hover:text-white'}">Profil Desa</a
						>
						<a
							href="/data-desa"
							class="transition-colors {$page.url.pathname === '/data-desa'
								? 'text-white underline underline-offset-4 decoration-2'
						...
						<div class="relative group py-2">
							<button
								class="flex items-center transition-colors {$page.url.pathname.startsWith(
									'/lembaga'
								)
									? 'text-white underline underline-offset-4 decoration-2'
							...
							<div class="absolute left-0 top-full pt-1 w-48 hidden group-hover:block">
								<div
									class="bg-white rounded-md shadow-lg py-2 border border-gray-100 text-gray-700 font-medium"
								>
									<a
										href="/lembaga/pkk"
										class="block px-4 py-2 hover:bg-green-50 hover:text-green-700">PKK</a
									>
									<a
										href="/lembaga/tk-pkk"
										class="block px-4 py-2 hover:bg-green-50 hover:text-green-700">TK PKK</a
									>
								</div>
							</div>
						</div>
						...
						<div class="relative group py-2">
							...
							<div class="absolute left-0 top-full pt-1 w-48 hidden group-hover:block">
								...
								>
									...
									<a
										href="/informasi/umkm"
										class="block px-4 py-2 hover:bg-green-50 hover:text-green-700">UMKM</a
									>
								</div>
							</div>
						</div>
						...
						<a
							href="/layanan-surat"
							class="px-5 py-2 bg-white text-green-700 hover:bg-green-50 rounded-full transition-all shadow-sm hover:shadow-md text-sm font-bold transform hover:-translate-y-0.5"
							>Layanan Surat</a
						>
					</div>
			...
			{#if isMenuOpen}
				<div class="md:hidden bg-green-700 border-t border-green-600 shadow-lg">
					<ul class="flex flex-col px-4 pt-2 pb-6 space-y-3 font-bold">
						...
						<li>
							<div class="py-2 text-white">Lembaga</div>
						...
						<li>
							<div class="py-2 text-white">Informasi</div>
							<ul class="pl-4 space-y-2 font-medium text-sm text-green-100">
								<li>
									<a href="/informasi/berita" class="block py-1 hover:text-white"
										>Berita & Pengumuman</a
									>
								</li>
						...
						<li>
							<a
								href="/layanan-surat"
								class="block py-3 mt-2 bg-white text-green-700 text-center rounded-md hover:bg-green-50 transition-colors"
								>Layanan Surat</a
							>
						</li>
					</ul>
